...
class FastPathMatcher(
    ...
    private fun loadDefaultRules() {
        ...
        addRule(patterns = listOf("diu tup", "du tup", "dut tup", "yutube", "youtube", "xem ca nhac", "mo youtube", "diu túp", "du túp", "đút túp", "xem ca nhạc", "nhac youtube", "xem youtube"), intent = "open_app", args = JSONObject().put("app_name", "youtube"), risk = "low", status = "success", confirm = false)
