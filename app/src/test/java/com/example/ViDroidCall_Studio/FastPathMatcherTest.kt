...
class FastPathMatcherTest {
    ...
    fun testNegativeCasesToAvoidFalsePositives() {
        assertNull(
            "Câu 'tôi nói chuyện về youtube' không được tự biến thành open_app",
            matcher.match("tôi nói chuyện về youtube")
        )
        assertNull(
            "Câu 'Tôi thích xem video ngắn' không được tự biến thành open_app",
            matcher.match("Tôi thích xem video ngắn")
        )
        assertNull(
            "Câu 'Tôi cần số điện thoại của anh' không được tự biến thành open_app",
            matcher.match("Tôi cần số điện thoại của anh")
        )
    ...
    fun testAll62RequiredSpecTestCases() {
        ...
        assertNotNull(r15); assertEquals(7, JSONObject(r15!!.argumentsJson).optInt("hour")); assertEquals(
            30,
            JSONObject(r15.argumentsJson).optInt("minute")
        )

        val r16 = matcher.match("báo thức bay gio ruoi")
        assertNotNull(r16); assertEquals(7, JSONObject(r16!!.argumentsJson).optInt("hour")); assertEquals(
            30,
            JSONObject(r16.argumentsJson).optInt("minute")
        )
        ...
        assertNotNull(r19); assertEquals(
            20,
            JSONObject(r19!!.argumentsJson).optInt("duration")
        ); assertEquals("seconds", JSONObject(r19.argumentsJson).optString("unit"))
        ...
        assertNotNull(r42); assertEquals("set_timer", r42?.intent); assertEquals(
            5,
            JSONObject(r42!!.argumentsJson).optInt("duration")
        )

        val r43 = relMatcher.match("năm phút nữa")
        assertNotNull(r43); assertEquals("set_timer", r43?.intent); assertEquals(
            5,
            JSONObject(r43!!.argumentsJson).optInt("duration")
        )

        val r44 = relMatcher.match("sau 2 tiếng")
        assertNotNull(r44); assertEquals("set_timer", r44?.intent); assertEquals(
            2,
            JSONObject(r44!!.argumentsJson).optInt("duration")
        ); assertEquals("hours", JSONObject(r44.argumentsJson).optString("unit"))

        val r45 = relMatcher.match("hai tiếng nữa")
        assertNotNull(r45); assertEquals("set_timer", r45?.intent); assertEquals(
            2,
            JSONObject(r45!!.argumentsJson).optInt("duration")
        )

        val r46 = relMatcher.match("sau 20 giây")
        assertNotNull(r46); assertEquals("set_timer", r46?.intent); assertEquals(
            20,
            JSONObject(r46!!.argumentsJson).optInt("duration")
        ); assertEquals("seconds", JSONObject(r46.argumentsJson).optString("unit"))

        val r47 = relMatcher.match("hai mươi giây nữa")
        assertNotNull(r47); assertEquals("set_timer", r47?.intent); assertEquals(
            20,
            JSONObject(r47!!.argumentsJson).optInt("duration")
        )

        val r48 = relMatcher.match("nửa tiếng nữa")
        assertNotNull(r48); assertEquals("set_timer", r48?.intent); assertEquals(
            30,
            JSONObject(r48!!.argumentsJson).optInt("duration")
        )

        val r49 = relMatcher.match("sau nửa giờ")
        assertNotNull(r49); assertEquals("set_timer", r49?.intent); assertEquals(
            30,
            JSONObject(r49!!.argumentsJson).optInt("duration")
        )
        ...
        for ((query, expectedApp) in appAliasMap) {
            ...
            assertEquals(
                "App name mismatch for '$query'",
                expectedApp,
                JSONObject(res!!.argumentsJson).optString("app_name")
            )
        }
    }
    ...
    @Test
    fun testGranularNumber_mot() = assertEquals(1, VietnameseNumberParser.parse("một"))
    @Test
    fun testGranularNumber_hai() = assertEquals(2, VietnameseNumberParser.parse("hai"))
    @Test
    fun testGranularNumber_ba() = assertEquals(3, VietnameseNumberParser.parse("ba"))
    @Test
    fun testGranularNumber_bon() = assertEquals(4, VietnameseNumberParser.parse("bốn"))
    @Test
    fun testGranularNumber_tu() = assertEquals(4, VietnameseNumberParser.parse("tư"))
    @Test
    fun testGranularNumber_nam() = assertEquals(5, VietnameseNumberParser.parse("năm"))
    @Test
    fun testGranularNumber_lam() = assertEquals(5, VietnameseNumberParser.parse("lăm"))
    @Test
    fun testGranularNumber_sau() = assertEquals(6, VietnameseNumberParser.parse("sáu"))
    @Test
    fun testGranularNumber_bay() = assertEquals(7, VietnameseNumberParser.parse("bảy"))
    @Test
    fun testGranularNumber_tam() = assertEquals(8, VietnameseNumberParser.parse("tám"))
    @Test
    fun testGranularNumber_chin() = assertEquals(9, VietnameseNumberParser.parse("chín"))
    @Test
    fun testGranularNumber_muoi() = assertEquals(10, VietnameseNumberParser.parse("mười"))
    @Test
    fun testGranularNumber_muoiMot() = assertEquals(11, VietnameseNumberParser.parse("mười một"))
    @Test
    fun testGranularNumber_muoiLam() = assertEquals(15, VietnameseNumberParser.parse("mười lăm"))
    @Test
    fun testGranularNumber_haiMuoi() = assertEquals(20, VietnameseNumberParser.parse("hai mươi"))
    @Test
    fun testGranularNumber_haiMuoiMot() = assertEquals(21, VietnameseNumberParser.parse("hai mươi mốt"))
    @Test
    fun testGranularNumber_haiMuoiTu() = assertEquals(24, VietnameseNumberParser.parse("hai mươi tư"))
    @Test
    fun testGranularNumber_haiMuoiLam() = assertEquals(25, VietnameseNumberParser.parse("hai mươi lăm"))

    // 2. ALARM HOUR WORDS TESTS
    @Test
    fun testGranularAlarm_sauGio() {
        val r = matcher.match("báo thức sáu giờ"); assertNotNull(r); assertEquals(
            6,
    ...
    @Test
    fun testGranularAlarm_sauGioNoAccents() {
        val r = matcher.match("báo thức sau gio"); assertNotNull(r); assertEquals(
            6,
            JSONObject(r!!.argumentsJson).optInt("hour")
        )
    }
    ...
    @Test
    fun testGranularAlarm_bayGioRuoi() {
        val r = matcher.match("báo thức bảy giờ rưỡi"); assertNotNull(r); assertEquals(
            7,
            JSONObject(r!!.argumentsJson).optInt("hour")
    ...
    @Test
    fun testGranularAlarm_bayGioRuoiNoAccents() {
        val r = matcher.match("báo thức bay gio ruoi"); assertNotNull(r); assertEquals(
            7,
            JSONObject(r!!.argumentsJson).optInt("hour")
        ); assertEquals(30, JSONObject(r.argumentsJson).optInt("minute"))
    }
    ...
    @Test
    fun testGranularAlarm_bayGioRuoiToi() {
        val r = matcher.match("báo thức 7 giờ rưỡi tối"); assertNotNull(r); assertEquals(
            19,
            JSONObject(r!!.argumentsJson).optInt("hour")
        ); assertEquals(30, JSONObject(r.argumentsJson).optInt("minute"))
    }
    ...
    @Test
    fun testGranularAlarm_haiGioRuoiChieu() {
        val r = matcher.match("báo thức 2 giờ rưỡi chiều"); assertNotNull(r); assertEquals(
            14,
            JSONObject(r!!.argumentsJson).optInt("hour")
        ); assertEquals(30, JSONObject(r.argumentsJson).optInt("minute"))
    }
    ...
    @Test
    fun testGranularAlarm_muoiGioSang() {
        val r = matcher.match("báo thức mười giờ sáng"); assertNotNull(r); assertEquals(
            10,
            JSONObject(r!!.argumentsJson).optInt("hour")
        )
    }
    ...
    @Test
    fun testGranularAlarm_muoiHaiGioTrua() {
        val r = matcher.match("báo thức mười hai giờ trưa"); assertNotNull(r); assertEquals(
            12,
            JSONObject(r!!.argumentsJson).optInt("hour")
        )
    }
    ...
    @Test
    fun testGranularAlarm_muoiHaiGioDem() {
        val r = matcher.match("báo thức mười hai giờ đêm"); assertNotNull(r); assertEquals(
            0,
            JSONObject(r!!.argumentsJson).optInt("hour")
        )
    }
    ...
    @Test
    fun testGranularAlarm_khongGioRuoi() {
        val r = matcher.match("báo thức không giờ rưỡi"); assertNotNull(r); assertEquals(
            0,
            JSONObject(r!!.argumentsJson).optInt("hour")
        ); assertEquals(30, JSONObject(r.argumentsJson).optInt("minute"))
    }
    ...
    @Test
    fun testGranularAlarm_7GioToi() {
        val r = matcher.match("báo thức 7 giờ tối"); assertNotNull(r); assertEquals(
            19,
            JSONObject(r!!.argumentsJson).optInt("hour")
        )
    }
    ...
    @Test
    fun testGranularAlarm_2GioChieu() {
        val r = matcher.match("báo thức 2 giờ chiều"); assertNotNull(r); assertEquals(
            14,
            JSONObject(r!!.argumentsJson).optInt("hour")
        )
    }
    ...
    @Test
    fun testGranularAlarm_8GioSang() {
        val r = matcher.match("báo thức 8 giờ sáng"); assertNotNull(r); assertEquals(
            8,
            JSONObject(r!!.argumentsJson).optInt("hour")
        )
    }
    ...
    @Test
    fun testGranularAlarm_11GioDem() {
        val r = matcher.match("báo thức 11 giờ đêm"); assertNotNull(r); assertEquals(
            23,
            JSONObject(r!!.argumentsJson).optInt("hour")
        )
    }
    ...
    @Test
    fun testGranularAlarm_12GioSang() {
        val r = matcher.match("báo thức 12 giờ sáng"); assertNotNull(r); assertEquals(
            0,
            JSONObject(r!!.argumentsJson).optInt("hour")
        )
    }
    ...
    @Test
    fun testGranularAlarm_12GioTrua() {
        val r = matcher.match("báo thức 12 giờ trưa"); assertNotNull(r); assertEquals(
            12,
            JSONObject(r!!.argumentsJson).optInt("hour")
        )
    }
    ...
    @Test
    fun testGranularAlarm_12GioDem() {
        val r = matcher.match("báo thức 12 giờ đêm"); assertNotNull(r); assertEquals(
            0,
            JSONObject(r!!.argumentsJson).optInt("hour")
        )
    }
    ...
    @Test
    fun testGranularAlarm_3GioChieu() {
        val r = matcher.match("báo thức 3 giờ chiều"); assertNotNull(r); assertEquals(
            15,
            JSONObject(r!!.argumentsJson).optInt("hour")
        )
    }
    ...
    @Test
    fun testGranularAlarm_9GioToi() {
        val r = matcher.match("báo thức 9 giờ tối"); assertNotNull(r); assertEquals(
            21,
            JSONObject(r!!.argumentsJson).optInt("hour")
        )
    }
    ...
    @Test
    fun testGranularAlarm_5GioSang() {
        val r = matcher.match("báo thức 5 giờ sáng"); assertNotNull(r); assertEquals(
            5,
            JSONObject(r!!.argumentsJson).optInt("hour")
        )
    }
    ...
    @Test
    fun testGranularAlarm_2GioKem10() {
        val r = matcher.match("báo thức 2 giờ kém 10"); assertNotNull(r); assertEquals(
            1,
            JSONObject(r!!.argumentsJson).optInt("hour")
    ...
    @Test
    fun testGranularAlarm_2GioKem10Phut() {
        val r = matcher.match("báo thức 2 giờ kém 10 phút"); assertNotNull(r); assertEquals(
            1,
            JSONObject(r!!.argumentsJson).optInt("hour")
        ); assertEquals(50, JSONObject(r.argumentsJson).optInt("minute"))
    }
    ...
    @Test
    fun testGranularAlarm_haiGioKemMuoi() {
        val r = matcher.match("báo thức hai giờ kém mười"); assertNotNull(r); assertEquals(
            1,
            JSONObject(r!!.argumentsJson).optInt("hour")
        ); assertEquals(50, JSONObject(r.argumentsJson).optInt("minute"))
    }
    ...
    @Test
    fun testGranularAlarm_haiGioKemMuoiPhut() {
        val r = matcher.match("báo thức hai giờ kém mười phút"); assertNotNull(r); assertEquals(
            1,
            JSONObject(r!!.argumentsJson).optInt("hour")
        ); assertEquals(50, JSONObject(r.argumentsJson).optInt("minute"))
    }
    ...
    @Test
    fun testGranularAlarm_7GioKem15() {
        val r = matcher.match("báo thức 7 giờ kém 15"); assertNotNull(r); assertEquals(
            6,
            JSONObject(r!!.argumentsJson).optInt("hour")
    ...
    @Test
    fun testGranularAlarm_bayGioKemMuoiLam() {
        val r = matcher.match("báo thức bảy giờ kém mười lăm"); assertNotNull(r); assertEquals(
            6,
            JSONObject(r!!.argumentsJson).optInt("hour")
        ); assertEquals(45, JSONObject(r.argumentsJson).optInt("minute"))
    }
    ...
    @Test
    fun testGranularAlarm_8GioKem5() {
        val r = matcher.match("báo thức 8 giờ kém 5"); assertNotNull(r); assertEquals(
            7,
            JSONObject(r!!.argumentsJson).optInt("hour")
        ); assertEquals(55, JSONObject(r.argumentsJson).optInt("minute"))
    }

    @Test
    fun testGranularAlarm_tamGioKemNam() {
        val r = matcher.match("báo thức tám giờ kém năm"); assertNotNull(r); assertEquals(
            7,
            JSONObject(r!!.argumentsJson).optInt("hour")
        ); assertEquals(55, JSONObject(r.argumentsJson).optInt("minute"))
    }
    ...
    @Test
    fun testGranularAlarm_2GioKem10Toi() {
        val r = matcher.match("báo thức 2 giờ kém 10 tối"); assertNotNull(r); assertEquals(
            19,
            JSONObject(r!!.argumentsJson).optInt("hour")
        ); assertEquals(50, JSONObject(r.argumentsJson).optInt("minute"))
    }
    ...
    @Test
    fun testGranularAlarm_7GioKem15Toi() {
        val r = matcher.match("báo thức 7 giờ kém 15 tối"); assertNotNull(r); assertEquals(
            18,
            JSONObject(r!!.argumentsJson).optInt("hour")
        ); assertEquals(45, JSONObject(r.argumentsJson).optInt("minute"))
    }
    ...
    @Test
    fun testGranularAlarm_8GioKem5Toi() {
        val r = matcher.match("báo thức 8 giờ kém 5 tối"); assertNotNull(r); assertEquals(
            19,
            JSONObject(r!!.argumentsJson).optInt("hour")
        ); assertEquals(55, JSONObject(r.argumentsJson).optInt("minute"))
    }
    ...
    @Test
    fun testGranularAlarm_11GioKem10Dem() {
        val r = matcher.match("báo thức 11 giờ kém 10 đêm"); assertNotNull(r); assertEquals(
            22,
            JSONObject(r!!.argumentsJson).optInt("hour")
        ); assertEquals(50, JSONObject(r.argumentsJson).optInt("minute"))
    }
    ...
    @Test
    fun testGranularAlarm_2GioThieu10() {
        val r = matcher.match("báo thức 2 giờ thiếu 10"); assertNotNull(r); assertEquals(
            1,
            JSONObject(r!!.argumentsJson).optInt("hour")
        ); assertEquals(50, JSONObject(r.argumentsJson).optInt("minute"))
    }
    ...
    @Test
    fun testGranularAlarm_12GioKem10Trua() {
        val r = matcher.match("báo thức 12 giờ kém 10 trưa"); assertNotNull(r); assertEquals(
            11,
            JSONObject(r!!.argumentsJson).optInt("hour")
        ); assertEquals(50, JSONObject(r.argumentsJson).optInt("minute"))
    }
    ...
    @Test
    fun testGranularAlarm_1GioKem10Trua() {
        val r = matcher.match("báo thức 1 giờ kém 10 trưa"); assertNotNull(r); assertEquals(
            12,
            JSONObject(r!!.argumentsJson).optInt("hour")
        ); assertEquals(50, JSONObject(r.argumentsJson).optInt("minute"))
    }
    ...
    @Test
    fun testGranularAlarm_12GioKem10Dem() {
        val r = matcher.match("báo thức 12 giờ kém 10 đêm"); assertNotNull(r); assertEquals(
            23,
            JSONObject(r!!.argumentsJson).optInt("hour")
        ); assertEquals(50, JSONObject(r.argumentsJson).optInt("minute"))
    }
    ...
    @Test
    fun testGranularAlarm_1GioKem10Dem() {
        val r = matcher.match("báo thức 1 giờ kém 10 đêm"); assertNotNull(r); assertEquals(
            0,
            JSONObject(r!!.argumentsJson).optInt("hour")
        ); assertEquals(50, JSONObject(r.argumentsJson).optInt("minute"))
    }
    ...
    @Test
    fun testGranularAlarm_2_45_Kem15() {
        val r = matcher.match("Đặt báo thức 2:45 kém 15"); assertNotNull(r); assertEquals(
            1,
            JSONObject(r!!.argumentsJson).optInt("hour")
        ); assertEquals(45, JSONObject(r.argumentsJson).optInt("minute"))
    }
    ...
    @Test
    fun testGoogleSttSpoken_2Gio45() {
        val r = matcher.match("Đặt báo thức 2 giờ 45"); assertNotNull(r); assertEquals(
            2,
            JSONObject(r!!.argumentsJson).optInt("hour")
        ); assertEquals(45, JSONObject(r.argumentsJson).optInt("minute"))
    }
    ...
    @Test
    fun testGranularTimer_15Phut() {
        val r = matcher.match("hẹn giờ 15 phút"); assertNotNull(r); assertEquals(
            15,
            JSONObject(r!!.argumentsJson).optInt("duration")
        )
    }

    @Test
    fun testGranularTimer_muoiLamPhut() {
        val r = matcher.match("hẹn giờ mười lăm phút"); assertNotNull(r); assertEquals(
            15,
            JSONObject(r!!.argumentsJson).optInt("duration")
        )
    }
    ...
    @Test
    fun testGranularTimer_muoiLamPhutNoAccents() {
        val r = matcher.match("hẹn giờ muoi lam phut"); assertNotNull(r); assertEquals(
            15,
            JSONObject(r!!.argumentsJson).optInt("duration")
        )
    }
    ...
    @Test
    fun testGranularTimer_20Giay() {
        val r = matcher.match("hẹn giờ 20 giây"); assertNotNull(r); assertEquals(
            20,
            JSONObject(r!!.argumentsJson).optInt("duration")
        ); assertEquals("seconds", JSONObject(r.argumentsJson).optString("unit"))
    }

    @Test
    fun testGranularTimer_haiMuoiGiay() {
        val r = matcher.match("hẹn giờ hai mươi giây"); assertNotNull(r); assertEquals(
            20,
            JSONObject(r!!.argumentsJson).optInt("duration")
        ); assertEquals("seconds", JSONObject(r.argumentsJson).optString("unit"))
    }
    ...
    @Test
    fun testGranularTimer_nuaTieng() {
        val r = matcher.match("hẹn giờ nua tieng"); assertNotNull(r); assertEquals(
            30,
            JSONObject(r!!.argumentsJson).optInt("duration")
        )
    }
    ...
    @Test
    fun testGranularTimer_nuaGio() {
        val r = matcher.match("hẹn giờ nua gio"); assertNotNull(r); assertEquals(
            30,
            JSONObject(r!!.argumentsJson).optInt("duration")
        )
    }
    ...
    @Test
    fun testGranularTimer_1Gio() {
        val r = matcher.match("hẹn giờ 1 giờ"); assertNotNull(r); assertEquals(
            1,
            JSONObject(r!!.argumentsJson).optInt("duration")
        ); assertEquals("hours", JSONObject(r.argumentsJson).optString("unit"))
    }

    @Test
    fun testGranularTimer_motTieng() {
        val r = matcher.match("hẹn giờ một tiếng"); assertNotNull(r); assertEquals(
            1,
            JSONObject(r!!.argumentsJson).optInt("duration")
        )
    }
    ...
    @Test
    fun testGranularTimer_30Phut() {
        val r = matcher.match("hẹn giờ 30 phút"); assertNotNull(r); assertEquals(
            30,
            JSONObject(r!!.argumentsJson).optInt("duration")
        )
    }
    ...
    @Test
    fun testGranularRelativeTimer_sau5Phut() {
        val r = relMatcher.match("sau 5 phút"); assertNotNull(r); assertEquals("set_timer", r?.intent); assertEquals(
            5,
            JSONObject(r!!.argumentsJson).optInt("duration")
        )
    }
    ...
    @Test
    fun testGranularRelativeTimer_namPhutNua() {
        val r = relMatcher.match("năm phút nữa"); assertNotNull(r); assertEquals(
            "set_timer",
            r?.intent
        ); assertEquals(5, JSONObject(r!!.argumentsJson).optInt("duration"))
    }

    @Test
    fun testGranularRelativeTimer_sau2Tieng() {
        val r = relMatcher.match("sau 2 tiếng"); assertNotNull(r); assertEquals("set_timer", r?.intent); assertEquals(
            2,
            JSONObject(r!!.argumentsJson).optInt("duration")
        ); assertEquals("hours", JSONObject(r.argumentsJson).optString("unit"))
    }
    ...
    @Test
    fun testGranularRelativeTimer_haiTiengNua() {
        val r = relMatcher.match("hai tiếng nữa"); assertNotNull(r); assertEquals("set_timer", r?.intent); assertEquals(
            2,
            JSONObject(r!!.argumentsJson).optInt("duration")
        )
    }
    ...
    @Test
    fun testGranularRelativeTimer_sau20Giay() {
        val r = relMatcher.match("sau 20 giây"); assertNotNull(r); assertEquals(
            "set_timer",
            r?.intent
        ); assertEquals(20, JSONObject(r!!.argumentsJson).optInt("duration")); assertEquals(
            "seconds",
            JSONObject(r.argumentsJson).optString("unit")
        )
    }

    @Test
    fun testGranularRelativeTimer_haiMuoiGiayNua() {
        val r = relMatcher.match("hai mươi giây nữa"); assertNotNull(r); assertEquals(
            "set_timer",
            r?.intent
        ); assertEquals(20, JSONObject(r!!.argumentsJson).optInt("duration"))
    }

    @Test
    fun testGranularRelativeTimer_nuaTiengNua() {
        val r = relMatcher.match("nửa tiếng nữa"); assertNotNull(r); assertEquals("set_timer", r?.intent); assertEquals(
            30,
            JSONObject(r!!.argumentsJson).optInt("duration")
        )
    }
    ...
    @Test
    fun testGranularRelativeTimer_sauNuaGio() {
        val r = relMatcher.match("sau nửa giờ"); assertNotNull(r); assertEquals(
            "set_timer",
            r?.intent
        ); assertEquals(30, JSONObject(r!!.argumentsJson).optInt("duration"))
    }

    // 7. APP ALIASES TESTS
    @Test
    fun testGranularApp_camera() {
        val r = matcher.match("mở camera"); assertNotNull(r); assertEquals(
            "open_app",
            r?.intent
        ); assertEquals("camera", JSONObject(r!!.argumentsJson).optString("app_name"))
    }

    @Test
    fun testGranularApp_mayAnh() {
        val r = matcher.match("mở máy ảnh"); assertNotNull(r); assertEquals(
            "open_app",
            r?.intent
        ); assertEquals("camera", JSONObject(r!!.argumentsJson).optString("app_name"))
    }
    ...
    @Test
    fun testGranularApp_gallery() {
        val r = matcher.match("mở gallery"); assertNotNull(r); assertEquals(
            "open_app",
            r?.intent
        ); assertEquals("gallery", JSONObject(r!!.argumentsJson).optString("app_name"))
    }

    @Test
    fun testGranularApp_boSuuTap() {
        val r = matcher.match("bo suu tap"); assertNotNull(r); assertEquals(
            "open_app",
            r?.intent
        ); assertEquals("gallery", JSONObject(r!!.argumentsJson).optString("app_name"))
    }
    ...
    @Test
    fun testGranularApp_contacts() {
        val r = matcher.match("danh ba"); assertNotNull(r); assertEquals(
            "open_app",
            r?.intent
        ); assertEquals("contacts", JSONObject(r!!.argumentsJson).optString("app_name"))
    }

    @Test
    fun testGranularApp_danhBa() {
        val r = matcher.match("mở danh bạ"); assertNotNull(r); assertEquals(
            "open_app",
            r?.intent
        ); assertEquals("contacts", JSONObject(r!!.argumentsJson).optString("app_name"))
    }
    ...
    @Test
    fun testGranularApp_calculator() {
        val r = matcher.match("mở máy tính"); assertNotNull(r); assertEquals(
            "open_app",
            r?.intent
        ); assertEquals("calculator", JSONObject(r!!.argumentsJson).optString("app_name"))
    }

    @Test
    fun testGranularApp_mayTinh() {
        val r = matcher.match("may tinh"); assertNotNull(r); assertEquals(
            "open_app",
            r?.intent
        ); assertEquals("calculator", JSONObject(r!!.argumentsJson).optString("app_name"))
    }
    ...
    @Test
    fun testGranularApp_playstore() {
        val r = matcher.match("ch play"); assertNotNull(r); assertEquals(
            "open_app",
            r?.intent
        ); assertEquals("playstore", JSONObject(r!!.argumentsJson).optString("app_name"))
    }

    @Test
    fun testGranularApp_youtube() {
        val r = matcher.match("mở youtube"); assertNotNull(r); assertEquals(
            "open_app",
            r?.intent
        ); assertEquals("youtube", JSONObject(r!!.argumentsJson).optString("app_name"))
    }

    @Test
    fun testGranularApp_duTup() {
        val r = matcher.match("du tup"); assertNotNull(r); assertEquals("open_app", r?.intent); assertEquals(
            "youtube",
            JSONObject(r!!.argumentsJson).optString("app_name")
        )
    }

    @Test
    fun testGranularApp_yutube() {
        val r = matcher.match("yutube"); assertNotNull(r); assertEquals("open_app", r?.intent); assertEquals(
            "youtube",
            JSONObject(r!!.argumentsJson).optString("app_name")
        )
    }
    ...
    @Test
    fun testGranularApp_facebook() {
        val r = matcher.match("mở facebook"); assertNotNull(r); assertEquals(
            "open_app",
            r?.intent
        ); assertEquals("facebook", JSONObject(r!!.argumentsJson).optString("app_name"))
    }

    @Test
    fun testGranularApp_phayBuc() {
        val r = matcher.match("phay buc"); assertNotNull(r); assertEquals(
            "open_app",
            r?.intent
        ); assertEquals("facebook", JSONObject(r!!.argumentsJson).optString("app_name"))
    }
    ...
    @Test
    fun testGranularApp_tiktok() {
        val r = matcher.match("mở tiktok"); assertNotNull(r); assertEquals(
            "open_app",
            r?.intent
        ); assertEquals("tiktok", JSONObject(r!!.argumentsJson).optString("app_name"))
    }

    @Test
    fun testGranularApp_topTop() {
        val r = matcher.match("top top"); assertNotNull(r); assertEquals("open_app", r?.intent); assertEquals(
            "tiktok",
            JSONObject(r!!.argumentsJson).optString("app_name")
        )
    }
    ...
    @Test
    fun testGranularApp_googleMaps() {
        val r = matcher.match("mở google maps"); assertNotNull(r); assertEquals(
            "open_app",
            r?.intent
        ); assertEquals("google_maps", JSONObject(r!!.argumentsJson).optString("app_name"))
    }

    @Test
    fun testGranularApp_gucGoMap() {
        val r = matcher.match("guc go map"); assertNotNull(r); assertEquals(
            "open_app",
            r?.intent
        ); assertEquals("google_maps", JSONObject(r!!.argumentsJson).optString("app_name"))
    }
    ...
    @Test
    fun testGranularApp_shopee() {
        val r = matcher.match("shopee"); assertNotNull(r); assertEquals("open_app", r?.intent); assertEquals(
            "shopee",
            JSONObject(r!!.argumentsJson).optString("app_name")
        )
    }
    ...
    @Test
    fun testGranularApp_lazada() {
        val r = matcher.match("lazada"); assertNotNull(r); assertEquals("open_app", r?.intent); assertEquals(
            "lazada",
            JSONObject(r!!.argumentsJson).optString("app_name")
        )
    }
    ...
    @Test
    fun testGranularApp_grab() {
        val r = matcher.match("grab"); assertNotNull(r); assertEquals("open_app", r?.intent); assertEquals(
            "grab",
            JSONObject(r!!.argumentsJson).optString("app_name")
        )
    }
    ...
    @Test
    fun testGranularApp_be() {
        val r = matcher.match("mở app be"); assertNotNull(r); assertEquals("open_app", r?.intent); assertEquals(
            "be",
            JSONObject(r!!.argumentsJson).optString("app_name")
        )
    }
    ...
    // 8. NEGATIVE TESTS
    @Test
    fun testGranularNegative_toiNoiChuyenVeYoutube() {
        assertNull(matcher.match("tôi nói chuyện về youtube"))
    }

    @Test
    fun testGranularNegative_toiThichXemVideoNgan() {
        assertNull(matcher.match("Tôi thích xem video ngắn"))
    }

    @Test
    fun testGranularNegative_toiCanSoDienThoai() {
        assertNull(matcher.match("Tôi cần số điện thoại của anh"))
    }

    @Test
    fun testGranularNegative_toiDangTinhToan() {
        assertNull(matcher.match("tôi đang tính toán"))
    }

    @Test
    fun testGranularNegative_unknownApp() {
        assertNull(matcher.match("tôi muốn mở ứng dụng lạ không có thật abc xyz"))
    }
    ...
    fun testVietnameseVoiceVariationsUpgrade() {
        ...
        assertNotNull(rSauGio); assertEquals("set_alarm", rSauGio?.intent); assertEquals(
            6,
            JSONObject(rSauGio!!.argumentsJson).optInt("hour")
        ); assertEquals(0, JSONObject(rSauGio.argumentsJson).optInt("minute"))

        val rSauGioUnaccented = matcher.match("báo thức sau gio")
        assertNotNull(rSauGioUnaccented); assertEquals("set_alarm", rSauGioUnaccented?.intent); assertEquals(
            6,
            JSONObject(rSauGioUnaccented!!.argumentsJson).optInt("hour")
        ); assertEquals(0, JSONObject(rSauGioUnaccented.argumentsJson).optInt("minute"))

        val rBayGioRuoi = matcher.match("báo thức bảy giờ rưỡi")
        assertNotNull(rBayGioRuoi); assertEquals("set_alarm", rBayGioRuoi?.intent); assertEquals(
            7,
            JSONObject(rBayGioRuoi!!.argumentsJson).optInt("hour")
        ); assertEquals(30, JSONObject(rBayGioRuoi.argumentsJson).optInt("minute"))

        val rBayGioRuoiUnaccented = matcher.match("báo thức bay gio ruoi")
        assertNotNull(rBayGioRuoiUnaccented); assertEquals("set_alarm", rBayGioRuoiUnaccented?.intent); assertEquals(
            7,
            JSONObject(rBayGioRuoiUnaccented!!.argumentsJson).optInt("hour")
        ); assertEquals(30, JSONObject(rBayGioRuoiUnaccented.argumentsJson).optInt("minute"))

        val rMuoiLamPhut = matcher.match("hẹn giờ mười lăm phút")
        assertNotNull(rMuoiLamPhut); assertEquals("set_timer", rMuoiLamPhut?.intent); assertEquals(
            15,
            JSONObject(rMuoiLamPhut!!.argumentsJson).optInt("duration")
        ); assertEquals("minutes", JSONObject(rMuoiLamPhut.argumentsJson).optString("unit"))

        val rMuoiLamPhutUnaccented = matcher.match("hẹn giờ muoi lam phut")
        assertNotNull(rMuoiLamPhutUnaccented); assertEquals("set_timer", rMuoiLamPhutUnaccented?.intent); assertEquals(
            15,
            JSONObject(rMuoiLamPhutUnaccented!!.argumentsJson).optInt("duration")
        )

        val rHaiMuoiGiay = matcher.match("hẹn giờ hai mươi giây")
        assertNotNull(rHaiMuoiGiay); assertEquals("set_timer", rHaiMuoiGiay?.intent); assertEquals(
            20,
            JSONObject(rHaiMuoiGiay!!.argumentsJson).optInt("duration")
        ); assertEquals("seconds", JSONObject(rHaiMuoiGiay.argumentsJson).optString("unit"))

        val rHaiMuoiGiayUnaccented = matcher.match("hẹn giờ hai muoi giay")
        assertNotNull(rHaiMuoiGiayUnaccented); assertEquals("set_timer", rHaiMuoiGiayUnaccented?.intent); assertEquals(
            20,
            JSONObject(rHaiMuoiGiayUnaccented!!.argumentsJson).optInt("duration")
        ); assertEquals("seconds", JSONObject(rHaiMuoiGiayUnaccented.argumentsJson).optString("unit"))

        val rNuaTieng = matcher.match("hẹn giờ nửa tiếng")
        assertNotNull(rNuaTieng); assertEquals("set_timer", rNuaTieng?.intent); assertEquals(
            30,
            JSONObject(rNuaTieng!!.argumentsJson).optInt("duration")
        ); assertEquals("minutes", JSONObject(rNuaTieng.argumentsJson).optString("unit"))

        val rNuaGioUnaccented = matcher.match("hẹn giờ nua gio")
        assertNotNull(rNuaGioUnaccented); assertEquals("set_timer", rNuaGioUnaccented?.intent); assertEquals(
            30,
            JSONObject(rNuaGioUnaccented!!.argumentsJson).optInt("duration")
        ); assertEquals("minutes", JSONObject(rNuaGioUnaccented.argumentsJson).optString("unit"))

        // Test độc lập không từ tiền tố
        val rStandalone1 = matcher.match("sau gio")
        assertNotNull(rStandalone1); assertEquals("set_alarm", rStandalone1?.intent); assertEquals(
            6,
            JSONObject(rStandalone1!!.argumentsJson).optInt("hour")
        )

        val rStandalone2 = matcher.match("bay gio ruoi")
        assertNotNull(rStandalone2); assertEquals("set_alarm", rStandalone2?.intent); assertEquals(
            7,
            JSONObject(rStandalone2!!.argumentsJson).optInt("hour")
        ); assertEquals(30, JSONObject(rStandalone2.argumentsJson).optInt("minute"))

        val rStandalone3 = matcher.match("muoi lam phut")
        assertNotNull(rStandalone3); assertEquals("set_timer", rStandalone3?.intent); assertEquals(
            15,
            JSONObject(rStandalone3!!.argumentsJson).optInt("duration")
        ); assertEquals("minutes", JSONObject(rStandalone3.argumentsJson).optString("unit"))

        val rStandalone4 = matcher.match("hai muoi giay")
        assertNotNull(rStandalone4); assertEquals("set_timer", rStandalone4?.intent); assertEquals(
            20,
            JSONObject(rStandalone4!!.argumentsJson).optInt("duration")
        ); assertEquals("seconds", JSONObject(rStandalone4.argumentsJson).optString("unit"))

        val rStandalone5 = matcher.match("nua tieng")
        assertNotNull(rStandalone5); assertEquals("set_timer", rStandalone5?.intent); assertEquals(
            30,
            JSONObject(rStandalone5!!.argumentsJson).optInt("duration")
        ); assertEquals("minutes", JSONObject(rStandalone5.argumentsJson).optString("unit"))
